    ...
    new Vue({
        ...
        watch: {
            ...
            'contract.balance'() {
                ...
                odometer.update(parseInt(this.contract.balance * 1));
            }
        },
        methods: {
            ...
            deposit(upline) {
                ...
                //if(this.user.deposit_amount > 0 && Math.floor(this.user.deposit_amount * 3 - this.user.payouts) > 0) return this.notice('You did not receive all the income 300%. You need to get ' + (this.user.deposit_amount * 3 - this.user.payouts).toFixed(2) + ' TRX.<br/>Make a new deposit when you receive all the income.', 'fb8c00');
            ...
            withdraw() {
                ...
                if(this.user.payouts >= this.user.deposit_amount * 3) return this.notice('You have reached the 300% limit<br/>To get income again make a new deposit', 'fb8c00');
